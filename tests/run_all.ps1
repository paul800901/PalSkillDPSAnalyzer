...
if ($workshopInfo.Version -ne "0.1.2") { throw "unexpected Workshop version" }
...
try {
    ...
    if ($testExitCode -ne 0 -or -not ($testOutput -match "v0\.1\.2 diagnostic/source/thread/lifetime/stress tests passed")) {
