...
if ($workshopInfo.Version -ne "0.5.14") { throw "unexpected Workshop version" }
...
try {
    ...
    if ($testExitCode -ne 0 -or -not ($testOutput -match "v0\.5\.14 damage-lab/display/multitarget/source/thread/lifetime/stress tests passed")) {
