...
if ($workshopInfo.Version -ne "0.5.15") { throw "unexpected Workshop version" }
...
try {
    ...
    if ($testExitCode -ne 0 -or -not ($testOutput -match "v0\.5\.15 damage-lab/display/multitarget/source/thread/lifetime/stress tests passed")) {
