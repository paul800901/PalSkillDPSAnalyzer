...
PalSkillDPSAnalyzer is an independent diagnostic mod maintained by
`paul800901`.

Its Boss encounter detection, participant-safe chat delivery, Pal ownership
resolution, and test harness were derived from
