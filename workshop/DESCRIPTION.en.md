...
[*]v0.5.41 reconnects one delayed Psychokinesis follow-up to the same exact cast, Pal and target. BP700/Dark is only a guard, never ownership by itself. A duplicate tail, different target, incomplete loadout, missing cast ID or competing exact BP700/Dark skill remains unresolved.
...
[*]v0.5.40's native source bridge and meteor Rock-to-Ring identity links are retained. UE4SS and PalSchema are not modified by this update.
[/list]
...
[*][b]Current version:[/b] v0.5.41. Windows single-player target; UE4SS Experimental required.
[/list]
