...
$vdf = @(
    ...
    '    "changenote" "v0.5.17: probes the native Pal damage utility call chain for exact Filter/Waza attribution; missing sources remain unresolved."'
    '}'
) -join "`r`n"
...
$metadata.changenote = "v0.5.17: probes the native Pal damage utility call chain for exact Filter/Waza attribution; missing sources remain unresolved."
$metadata.last_published_version = "0.5.17"
