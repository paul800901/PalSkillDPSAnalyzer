...
$vdf = @(
    ...
    '    "changenote" "v0.4.2: isolates the HUD from Unreal UMG and PrintString by using a bundled transparent Windows overlay."'
    '}'
) -join "`r`n"
...
$metadata.changenote = "v0.4.2: isolates the HUD from Unreal UMG and PrintString by using a bundled transparent Windows overlay."
$metadata.last_published_version = "0.4.2"
